...
class AsyncRestClient:
    ...
    def request(self, method, url, **kwargs):
        url = f'https://127.0.0.1:53333/api/v3.1/{url}'
        merged_kwargs = {}
        merged_kwargs.update(self._kwargs)
        merged_kwargs.update(kwargs)
        return self._session.request(method, url, **merged_kwargs)
...
class CloudifyWorkflowContextInternal(object):
    ...
    def send_workflow_event(self,
                            ...
                            args=None,
                            additional_context=None):
        return self.handler.send_workflow_event(event_type=event_type,
                                         message=message,
                                         args=args,
...
class RemoteContextHandler(CloudifyWorkflowContextHandler):
    ...
    def operation_cloudify_context(self):
        return {'local': False,
                ...
                'execution_token': self.workflow_ctx.execution_token}
